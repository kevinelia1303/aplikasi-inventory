              ...
              <form method="post" action="{{ route('submitData1') }}" class="form-horizontal">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="id_PurchaseOrder" readonly="" value="{{ 'PG'.date('Y').'-'.date('m').$kd }}" placeholder="ID Purchase Order .." required>
                    </div>
                  </div>
                  <div class="form-group row">
    ...
    $(document).ready(function () {
        ...
        $('thead').on('click', '.addRow', function () {
            ...
            var html = "<tr style='border:1px solid' id='baris'" +baris+  ">"
                ...
                html += "</td>"
                html += "<td style='border:1px solid'>"
                html += "<input type='number' step='100' class='form-control' name='harga[]' id='harga" +baris+"' name='harga' required>"
                html += "</td>"
                html += "<td style='border:1px solid'>"
