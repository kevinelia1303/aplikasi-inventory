                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control" name="jenis_bayar" required>
                        <option {{ $potwisting->jenis_bayar == 'Kredit' ? 'selected' : '' }} value="Kredit">Kredit</option>
                        <option {{ $potwisting->jenis_bayar == 'Cash' ? 'selected' : '' }} value="Cash">Cash</option>
                    </select>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control" name="shipment" required>
                        <option {{ $potwisting->shipment == 'Partial Shipment' ? 'selected' : '' }} value="Partial Shipment">Partial Shipment</option>
                        <option {{ $potwisting->shipment == 'Full Shipment' ? 'selected' : '' }} value="Full Shipment">Full Shipment</option>
                    </select>
                    </div>
                </div>
                <div class="form-group row">
