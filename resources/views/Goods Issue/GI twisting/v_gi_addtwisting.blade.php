              ...
              <form method="post" action="{{ route('submitData6') }}" class="form-horizontal">
                ...
                <div class="card-body">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="id_Transaksi"  value="{{ 'DM'.date('Y').'-'.date('m').$kd }}" placeholder="ID Goods Issue .." required>
                    </div>
                  </div>
                  <div class="form-group row">
                ...
                <p>
                  <a class="btn btn-primary" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                    Detail Item Purchase Order Maklon Twisting
                  </a>
                </p>
