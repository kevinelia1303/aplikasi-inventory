...
@section('title', 'GR DF')
@section('content')
    <h1>Add Goods Receipt Maklon Dyeing Finishing</h1>
                ...
                <div class="card-body">
                  <input type="hidden" value="{{ Auth::user()->id }}" name="id_user" required>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="id_Transaksi" readonly="" value="{{ 'RJ'.date('Y').'-'.date('m').$kd }}" placeholder="ID Goods Receipts .." required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">ID Purchase Order</label>
                    <div class="col-sm-10">
                      <input type="text" readonly value="{{ $purchase->id_PurchaseOrder }}" class="form-control" name="id_PurchaseOrder" placeholder="ID Purchase Order .." required>
                    </div>
                  </div>
                  <div class="form-group row">
